...
@Component({
  selector: 'app-summary-catalog-admin',
  templateUrl: './summary-catalog-backend-admin.component.html',
  styleUrls: ['./summary-catalog-backend-admin.component.css']
})
export class SummaryCatalogAdminComponent implements OnInit, AfterViewInit {
  ...
  constructor(public categorySvc: CategoryService, private fis: FormInfoService, public translate: TranslateService) {
    this.categorySvc.getCatalogAdmin().subscribe(categories => {
